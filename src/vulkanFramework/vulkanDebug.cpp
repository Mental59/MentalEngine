...
VKAPI_ATTR VkBool32 VKAPI_CALL reportCallback(VkDebugReportFlagsEXT flags, VkDebugReportObjectTypeEXT objectType,
...
{
	const VkDebugUtilsMessengerCreateInfoEXT messengerCreateInfo = debugUtilsMessengerCreateInfo();
	MENTAL_VK_CHECK(vkCreateDebugUtilsMessengerEXT(instance, &messengerCreateInfo, nullptr, messenger));

	const VkDebugReportCallbackCreateInfoEXT reportCallbackCreateInfo = debugReportCallbackCreateInfo();
	MENTAL_VK_CHECK(vkCreateDebugReportCallbackEXT(instance, &reportCallbackCreateInfo, nullptr, reportCallback));
}
