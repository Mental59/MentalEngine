...
core::Result DeviceFactory::choosePhysicalDevice(
  VkInstance instance, VkSurfaceKHR surface, PhysicalDeviceInfo& physicalDeviceInfo) const
{
  VkResult vkRes;
...
PhysicalDeviceInfo::PhysicalDeviceInfo(VkPhysicalDevice physicalDevice,
...
SwapchainSupportDetails PhysicalDeviceInfo::querySwapchainSupport() const
{
  ...
  if (modesCount > 0)
  {
    ...
    vkGetPhysicalDeviceSurfacePresentModesKHR(
      mPhysicalDevice, mSurface, &modesCount, supportDetails.presentModes.data());
  }
